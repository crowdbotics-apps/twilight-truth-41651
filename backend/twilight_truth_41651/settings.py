"""
Django settings for twilight_truth_41651 project.
...
ROOT_URLCONF = 'twilight_truth_41651.urls'
...
WSGI_APPLICATION = 'twilight_truth_41651.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_truth_41651 API",
    "DESCRIPTION": "API documentation for twilight_truth_41651 App",
    "VERSION": "v1",
}
